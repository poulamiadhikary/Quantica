    ...
    <>
      <div className='h-auto w-full flex flex-col items-center relative'>
        ...
        <div className='h-56 sm:h-72 lg:h-96 w-90% relative overflow-hidden flex justify-center items-end font-MavenPro font-bold'>
          ...
          <h1 className='z-30 text-white text-3xl text-center absolute sm:w-80% sm:text-4xl lg:text-6xl border-b-2 border-white w-70% p-5'>Backend Developer</h1>
        </div>

        <Accordian title="Learn a programming language" desc=" Popular backend languages include: JavaScript, Python, Java, Ruby, PHP" />
        <Accordian title="Learn about databases" desc=" There are two types of databases you can learn, mainly SQL & NoSQL . Example of SQL database is MySQL and example of NoSQL is mongoDb." />
        ...
        <h2 className='text-white font-MavenPro text-2xl md:text-4xl lg:text-5xl w-60% border-b-2 text-center font-bold'>Projects</h2>
        <p className='text-white font-Jura px-12 py-7 sm:px-24 sm:py-10 md:px-32 lg:px-40 text-s md:text-sm lg:text-lg'> 1. E-commerce platform
          <br></br><br></br>2. To-Do list app with database integration
          <br></br> <br></br>3. Online learning platform
          <br></br> <br></br>4. Real time chat application
          <br></br> <br></br>5. Online job portal
          <br></br> <br></br>6. User authentication system
        </p>
