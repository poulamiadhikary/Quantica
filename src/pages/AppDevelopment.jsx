    ...
    <>
      <div className='h-auto w-full flex flex-col items-center relative'>
        ...
        <div className='h-56 sm:h-72 lg:h-96 w-90% relative overflow-hidden flex justify-center items-end font-MavenPro font-bold'>
          ...
          <h1 className='z-30 text-white text-3xl text-center absolute sm:w-80% sm:text-4xl lg:text-6xl border-b-2 border-white w-70% p-5'>App Development</h1>
        </div>

        <p className='text-s sm:text-sm lg:text-lg text-white font-Jura text-center px-16 mt-7 lg:mt-11'>In mobile developemt you have two choices either you can go for native apps which are specifically for android or ios. Or you can go for cross platform which will be platform independent.</p>
