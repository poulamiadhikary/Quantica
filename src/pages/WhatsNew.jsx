        ...
        <>
            <div className='h-auto w-full flex flex-col items-center relative'>
                ...
                <div className='phone:h-56 sm:h-72 lg:h-96 w-90% relative overflow-hidden flex justify-center items-end font-MavenPro font-bold'>
                    ...
                    <h1 className='z-30 text-white phone:text-3xl text-center absolute sm:w-80% sm:text-4xl lg:text-6xl border-b-2 border-white phone:w-70% p-5'>What's New in Quantica ?</h1>
                </div>

                <p className='font-Jura text-gray-500 phone:text-sm md:text-lg phone:px-10 sm:px-14 md:px-24 mt-24 text-center'>Everything is updated as on 27 . 08 . 24<br></br>All new updates will show up here.</p>
                 <div className=' h-[55vh] w-80% flex flex-col px-3 justify-end phone:gap-2'></div>
