    ...
    <>
      <div className='h-auto w-full flex flex-col items-center relative'>
        ...
        <div className='h-56 sm:h-72 lg:h-96 w-90% relative overflow-hidden flex justify-center items-end font-MavenPro font-bold'>
          ...
          <h1 className='z-30 text-white text-3xl text-center absolute sm:w-80% sm:text-4xl lg:text-6xl border-b-2 border-white w-70% p-5'>Mail Us</h1>
        </div>

        <p className='font-Jura text-white text-sm md:text-lg px-10 sm:px-14 md:px-24 md:mt-12 mt-8 text-center'>Didn't found your required roadmap, resources ?<br></br>Have any issue with any of our content ?<br></br>Want to add something ?<br></br>Have a Query ?</p>
        <button className='text-sm md:text-lg lg:text-2xl bg-gradient-to-r from-purple-400 to-purple-800 mt-8 text-white font-Jura px-3 py-1 lg:px-10 lg:py-5 rounded-md cursor-pointer' onClick={clickMail}>Mail Us</button>
